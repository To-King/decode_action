//Wed Oct 23 2024 10:08:43 GMT+0000 (Coordinated Universal Time)
...
!(async () => {
  ...
  if ($.isNode()) {
    ...
    console.log("\n=== 脚本执行 - 北京时间：" + new Date(new Date().getTime() + new Date().getTimezoneOffset() * 60 * 1000 + 28800000).toLocaleString() + " ===");
    console.log("\n===【共 " + user_num + " 个账号】===");
    subTitle = "";
    await get_zu();
  } else {
...
function Format_time(_0x2612bb) {
  ...
  let _0x5d0179 = _0x3c1331 + _0x3edc07 + _0x3acc8e + _0x11e5cd + _0x4cd0b7 + _0x115848;
